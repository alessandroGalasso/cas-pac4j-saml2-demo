...
/*
 * 
 * param logoutRequest missing ... added in the url ..for now to make logout work
 * 
 */
...
public final class LogoutManagerImpl implements LogoutManager {
    ...
    private boolean performBackChannelLogout(final LogoutRequest request) {
		...
		try {
			originalUrl = request.getService().getOriginalUrl()
					+"?logoutRequest="+ URLEncoder.encode(logoutRequest, "UTF-8" );
