...
public class SAMLDiscovery extends GenericFilterBean {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
    	...
    	System.out.println("----> SAMLDiscovery doFilter");
    ...
    protected void processDiscoveryRequest(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
    	...
    	System.out.println("----> SAMLDiscovery processDiscoveryRequest");
        ...
        System.out.println("---->2 SAMLDiscovery processDiscoveryRequest");
        ...
        System.out.println("----> 3 SAMLDiscovery processDiscoveryRequest");
        ...
        if (isPassive != null && "true".equals(isPassive)) {
        	...
        	System.out.println("----> SAMLDiscovery isPassive");
        	...
        	System.out.println("----> SAMLDiscovery getIdpSelectionPath");
            ...
            sendPassiveResponse(request, response, returnURL, returnParam, passiveIDP);
           	...
           	System.out.println("----> SAMLDiscovery sendIDPSelection");
    ...
    protected void sendIDPSelection(HttpServletRequest request, HttpServletResponse response, String responseURL, String returnParam) throws IOException, ServletException {
    	...
    	System.out.println("----> SAMLDiscovery protected void sendIDPSelection");
        ...
        System.out.println("----> SAMLDiscovery responseURL "+responseURL);
        System.out.println("----> SAMLDiscovery RETURN_PARAM "+returnParam);


        String path = getIdpSelectionPath();
        
        System.out.println("----> SAMLDiscovery path "+path);
