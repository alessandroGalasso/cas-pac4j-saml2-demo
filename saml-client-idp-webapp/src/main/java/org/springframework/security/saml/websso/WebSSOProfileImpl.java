...
public class WebSSOProfileImpl extends AbstractProfileBase implements WebSSOProfile {
    ...
    public void sendAuthenticationRequest(SAMLMessageContext context, WebSSOProfileOptions options) throws SAMLException, MetadataProviderException, MessageEncodingException {
    	...
    	System.out.println("----> WebSSOProfileImpl sendAuthenticationRequest");
        ...
        System.out.println("---->1 WebSSOProfileImpl sendMessage(context, sign);");
        
        sendMessage(context, sign);
        
       
        System.out.println("---->3 WebSSOProfileImpl sendMessage(context, sign);");
        

        SAMLMessageStorage messageStorage = context.getMessageStorage();
        
    	
    	System.out.println("----> WebSSOProfileImpl getOutboundMessage |"+context.getOutboundMessage()+"|");
    	
    	Object o = context.getOutboundMessage();
    	
    	System.out.println("----> WebSSOProfileImpl getOutboundMessage |"+o.getClass()+"|");
        
        
    	org.opensaml.saml2.core.impl.AuthnRequestImpl a = (AuthnRequestImpl) o;
    	
    	
    	
        if (messageStorage != null) {
        	
        	System.out.println("----> WebSSOProfileImpl messageStorage != null");
