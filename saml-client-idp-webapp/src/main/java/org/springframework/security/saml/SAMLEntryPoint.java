...
public class SAMLEntryPoint extends GenericFilterBean implements AuthenticationEntryPoint {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
    	...
    	System.out.println("----> SAMLEntryPoint doFilter");
    	
        FilterInvocation fi = new FilterInvocation(request, response, chain);

        if (!processFilter(fi.getRequest())) {
        	System.out.println("----> SAMLEntryPoint chain.doFilter(request, response);");
    ...
    public void commence(HttpServletRequest request, HttpServletResponse response, AuthenticationException e) throws IOException, ServletException {
    	...
    	System.out.println("----> SAMLEntryPoint commence");
        ...
        try {
            ...
            if (isECP(context)) {
            	System.out.println("----> SAMLEntryPoint initializeECP");
                initializeECP(context, e);
            } else if (isDiscovery(context)) {
            	
            	//fa il redirect a saml/discovery/alias/app.alessandro.it che printa la form con la scelta degli idp
            	
            	// la form poi manda in 
            	// action="/saml/login/alias/app.alessandro.it?disco=true" method="GET"
            	//con  name="idp" value="https://idp.alessandro.it/idp/shibboleth"/>
            	  // ---> che fa partire il vero   initializeSSO
            	
            	System.out.println("----> SAMLEntryPoint initializeDiscovery");
                initializeDiscovery(context);
            } else {
            	System.out.println("----> SAMLEntryPoint initializeSSO");
        ...
        System.out.println("----> SAMLEntryPoint commence2");
    ...
    protected void initializeSSO(SAMLMessageContext context, AuthenticationException e) throws MetadataProviderException, SAMLException, MessageEncodingException {
    	...
    	System.out.println("----> SAMLEntryPoint protected void initializeSSO(");
        ...
        System.out.println("----> SAMLEntryPoint protected void initializeSSO( 2 ");
        ...
        System.out.println("----> SAMLEntryPoint protected void initializeSSO( 3"); 
        // HoK WebSSO
        if (SAMLConstants.SAML2_HOK_WEBSSO_PROFILE_URI.equals(consumerService.getBinding())) {
        	
        	System.out.println("----> SAMLEntryPoint initializeSSO SAML2_HOK_WEBSSO_PROFILE_URI");
        	
            if (webSSOprofileHoK == null) {
            	
              	System.out.println("----> SAMLEntryPoint initializeSSO webSSOprofileHoK");
                ...
                logger.warn("WebSSO HoK profile was specified to be used, but profile is not configured in the EntryPoint, HoK will be skipped");
              	...
              	System.out.println("----> SAMLEntryPoint initializeSSO using WebSSO HolderOfKey profile");
        ...
        System.out.println("----> SAMLEntryPoint  webSSOprofile.sendAuthenticationRequest");
    ...
    protected void initializeDiscovery(SAMLMessageContext context) throws ServletException, IOException, MetadataProviderException {
        ...
        System.out.println("----> SAMLEntryPoint initializeDiscovery discoveryURL "+discoveryURL);
        ...
        if (discoveryURL != null) {
            ...
            System.out.println("----> 2 SAMLEntryPoint initializeDiscovery discoveryURL "+discoveryURL);
